 ...
 * Generated at: 2023-06-01 22:34:48 UTC
...
public final class clientes_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("            </div>\r\n");
      out.write("            <div class=\"organizacontainer\">\r\n");
      out.write("                <div class=\"formulariodecadastro\">\r\n");
      out.write("                    <form method=\"post\" action=\"/create-cliente\" class=\"form\">\r\n");
      out.write("                        <div class=\"cadastro\">\r\n");
      out.write("                            <div class=\"os\">\r\n");
      out.write("                                <label for=\"id\">ID</label><br>\r\n");
      out.write("                                <input readonly type=\"text\" id=\"os\" name=\"os\" value=");
      ...
      out.write("                                    <input type=\"text\" id=\"cpf\" name=\"cpf\" oninput=\"adicionarMascaraCPF(this)\" maxlength=\"11\"  value=");
      ...
      out.write("                                    <label for=\"dataNascimento\">Data de Nascimento</label><br>\r\n");
      out.write("                                    <input type=\"date\" id=\"dataNascimento\" name=\"dataNascimento\"\r\n");
      out.write("                                        value=");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${param.nacimento}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write(">\r\n");
      out.write("                                </div>\r\n");
      out.write("                            </div>\r\n");
      out.write("\r\n");
      ...
      out.write("                                    <input type=\"text\" id=\"telefone-1\" name=\"telefone-1\" maxlength=\"11\" value=");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${param.celular01}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write(">\r\n");
      out.write("                                </div>\r\n");
      out.write("                                <div class=\"ctd-telf2\">\r\n");
      out.write("                                    <label for=\"telefone-2\">Telefone 2 (Opcional)</label><br>\r\n");
      out.write("                                    <input type=\"text\" id=\"telefone-2\" name=\"telefone-2\" maxlength=\"11\" value=");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${param.celular02}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write(">\r\n");
      out.write("                                </div>\r\n");
      out.write("                            </div>\r\n");
      ...
      out.write("                                    <input type=\"text\" id=\"endereco\" name=\"endereco\" value=");
      ...
      out.write("        </div>\r\n");
      out.write("        <script>\r\n");
      out.write("            // Chamar a funÃ§Ã£o adicionarMascaraCPF apÃ³s renderizar o valor do parÃ¢metro JSP\r\n");
      out.write("            window.addEventListener('DOMContentLoaded', function() {\r\n");
      out.write("              const cpf = document.getElementById('cpf');\r\n");
      out.write("              adicionarMascaraCPF(cpf);\r\n");
      out.write("            });\r\n");
      out.write("\r\n");
      out.write("            function validarCPF(cpf) {\r\n");
      out.write("            cpf = cpf.replace(/\\D/g, \"\");\r\n");
      out.write("\r\n");
      out.write("            if (cpf.length !== 11 || /^[0-9]{11}$/.test(cpf) === false) {\r\n");
      out.write("                alert(\"CPF invÃ¡lido!\");\r\n");
      out.write("            } else {\r\n");
      out.write("                let sum = 0;\r\n");
      out.write("                let remainder;\r\n");
      out.write("\r\n");
      out.write("                for (let i = 1; i <= 9; i++) {\r\n");
      out.write("                    sum += parseInt(cpf.substring(i - 1, i)) * (11 - i);\r\n");
      out.write("                }\r\n");
      out.write("\r\n");
      out.write("                remainder = (sum * 10) % 11;\r\n");
      out.write("\r\n");
      out.write("                if (remainder === 10 || remainder === 11) {\r\n");
      out.write("                    remainder = 0;\r\n");
      out.write("                }\r\n");
      out.write("\r\n");
      out.write("                if (remainder !== parseInt(cpf.substring(9, 10))) {\r\n");
      out.write("                    alert(\"CPF invÃ¡lido!\");\r\n");
      out.write("                    return;\r\n");
      out.write("                }\r\n");
      out.write("\r\n");
      ...
      out.write("                    sum += parseInt(cpf.substring(i - 1, i)) * (12 - i);\r\n");
      out.write("                }\r\n");
      out.write("\r\n");
      out.write("                remainder = (sum * 10) % 11;\r\n");
      out.write("\r\n");
      ...
      out.write("                }\r\n");
      out.write("\r\n");
      out.write("                if (remainder !== parseInt(cpf.substring(10, 11))) {\r\n");
      out.write("                    alert(\"CPF invÃ¡lido!\");\r\n");
      out.write("                    return;\r\n");
      out.write("                }\r\n");
      out.write("\r\n");
      out.write("                alert(\"CPF vÃ¡lido!\");\r\n");
      out.write("            }\r\n");
      out.write("        }\r\n");
      out.write("        </script>\r\n");
      out.write("        <script>\r\n");
  ...
  private boolean _jspx_meth_c_005fforEach_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /clientes.jsp(100,24) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fforEach_005f0.setVar("cliente");
    // /clientes.jsp(100,24) name = items type = javax.el.ValueExpression reqTime = true required = false fragment = false deferredValue = true expectedTypeName = java.lang.Object deferredMethod = false methodSignature = null
    _jspx_th_c_005fforEach_005f0.setItems(new org.apache.jasper.el.JspValueExpression("/clientes.jsp(100,24) '${allClientes}'",_el_expressionfactory.createValueExpression(_jspx_page_context.getELContext(),"${allClientes}",java.lang.Object.class)).getValue(_jspx_page_context.getELContext()));
    ...
    try {
      ...
      if (_jspx_eval_c_005fforEach_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          ...
          out.write("\">\r\n");
          out.write("                                        <input type=\"hidden\" id=\"data-nascimento\" name=\"data-nascimento\" value=\"");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${cliente.celular01}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
          out.write("\">\r\n");
          out.write("                                        <input type=\"hidden\" id=\"endereco\" name=\"endereco\" value=\"");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${cliente.celular02}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
          out.write("\">\r\n");
          out.write("                                        <input type=\"hidden\" id=\"endereco\" name=\"endereco\" value=\"");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${cliente.endereco}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
          out.write("\">\r\n");
          ...
          out.write("\">\r\n");
          out.write("                                        <button id=\"button-update\"><a class=\"update\"\r\n");
          out.write("                                                href=\"clientes.jsp?id=");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${cliente.id}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
          out.write("&amp;name=");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${cliente.nome}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
          out.write("&amp;cpf=");
          ...
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${cliente.id}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
          out.write("\">\r\n");
          out.write("                                        <button id=\"button-delete\" type=\"submit\">Apagar</button>\r\n");
          out.write("                                    </form>\r\n");
          out.write("\r\n");
          out.write("                                </td>\r\n");
          out.write("\r\n");
